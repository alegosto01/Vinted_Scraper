...
from experiments.full_scrape_model.dataset import TASK_CHOICES, build_datasets
...
def run_sweep(
    *,
    ...
    write_manifest(out_dir / "manifest.json", command="full_scrape_model.model_sweep", extra=base_sweep.to_builtin(summary))
    return summary
