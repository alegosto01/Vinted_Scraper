...
- offline: experiments/old/photo_arbitrage/data/features/sold_unsold_visuals_20260514_full/combined_scored.csv
...
from experiments.current.full_scrape_giant_model._deps.full_scrape_model.compare_feature_modalities import VISUAL_NUMERIC  # noqa: E402
from experiments.current.full_scrape_giant_model.paths import ROOT  # noqa: E402

OFFLINE_VISUAL_SOURCE = (
    ROOT / "experiments" / "old" / "photo_arbitrage" / "data" / "features"
