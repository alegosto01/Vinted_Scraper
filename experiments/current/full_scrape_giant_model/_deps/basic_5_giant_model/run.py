...
from experiments.current.full_scrape_giant_model._deps.deal_finder.modeling import (  # noqa: E402
    ELIGIBLE_COL,
    TARGET_COL,
    choose_threshold,
    score_with_model,
)
from experiments.current.full_scrape_giant_model._deps.full_scrape_model.compare_feature_modalities import (  # noqa: E402
    BASIC_NUMERIC,
    BASIC_TEXT,
    EXPERIMENTAL_BASIC_APPROACHES,
)
from experiments.current.full_scrape_giant_model._deps.full_scrape_model.dataset import TASK_SOLD_STATUS, build_search_dataset  # noqa: E402
