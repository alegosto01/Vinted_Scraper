...
from experiments.current.full_scrape_giant_model._deps.deal_finder.dataset import add_identity
from experiments.current.full_scrape_giant_model._deps.deal_finder.model_sweep import (
    IMAGE_FEATURES,
    RulePriceScorer,
...
from experiments.current.full_scrape_giant_model._deps.deal_finder.modeling import load_pickle, score_with_model
from experiments.current.full_scrape_giant_model._deps.deal_finder.paper_trading import (
    checkpoint_due_mask,
