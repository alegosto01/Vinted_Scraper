...
from experiments.current.time_to_sell._deps.deal_finder.dataset import build_datasets, safe_feature_columns
...
def run_sweep(
    *,
    ...
    # ── Experiment tracker ──────────────────────────────────────────────────
    try:
        from experiments.current.time_to_sell._deps.tracking.db import init_db, log_run, log_metrics
        init_db()
