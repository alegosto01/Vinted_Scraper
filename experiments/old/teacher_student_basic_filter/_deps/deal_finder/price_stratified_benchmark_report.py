...
from experiments.old.teacher_student_basic_filter._deps.deal_finder.paths import REPORTS_DIR  # noqa: E402


DEFAULT_RUN_DIR = ROOT / "experiments" / "old" / "deal_finder" / "data" / "live_runs" / "hourly_all_models_benchmark_scheduled"
