...
from experiments.old.teacher_student_basic_filter._deps.deal_finder.dataset import add_identity
from experiments.old.teacher_student_basic_filter._deps.deal_finder.model_sweep import (
    IMAGE_FEATURES,
    RulePriceScorer,
...
from experiments.old.teacher_student_basic_filter._deps.deal_finder.modeling import load_pickle, score_with_model
from experiments.old.teacher_student_basic_filter._deps.deal_finder.paper_trading import (
    checkpoint_due_mask,
    ensure_outcome_columns,
    load_search_config_by_folder,
    update_outcome_windows,
)
from experiments.old.teacher_student_basic_filter._deps.deal_finder.paths import (
    LIVE_RUNS_DIR,
    MODELS_DIR,
...
def latest_sweep_run() -> Path:
    ...
    if not runs:
        raise FileNotFoundError("No sweep_* offline run found under experiments/old/deal_finder/data/offline_runs.")
    return runs[-1]
