...
def regenerate_dataset(visual_path: Path, dataset_dir: Path, search: str) -> None:
    ...
    from experiments.old.teacher_student_basic_filter._deps.full_scrape_model.compare_feature_modalities import (
...
def main() -> int:
    visual_path = ROOT / "experiments" / "old" / "photo_arbitrage" / "data" / "features" / "sold_unsold_visuals_20260514_full" / "combined_scored.csv"
    dataset_dir = ROOT / "experiments" / "old" / "full_scrape_model" / "data" / "offline_runs" / "sold_status_feature_modalities_20260518_082505" / "datasets"
