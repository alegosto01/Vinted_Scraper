...
from experiments.old.benchmark_basic_to_full._deps.full_scrape_model.dataset import TASK_CHOICES, build_datasets
...
def run_sweep(
    *,
    ...
    # ── Experiment tracker ──────────────────────────────────────────────────
    try:
        from experiments.old.benchmark_basic_to_full._deps.tracking.db import init_db, log_run, log_metrics
        init_db()
