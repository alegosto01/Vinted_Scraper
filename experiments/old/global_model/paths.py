...
VISUAL_FEATURES_DIR = ROOT / "experiments" / "old" / "photo_arbitrage" / "data" / "features"
PER_SEARCH_RUN_DIR = ROOT / "experiments" / "old" / "full_scrape_model" / "data" / "offline_runs"
LIVE_BENCHMARK_CSV = ROOT / "experiments" / "old" / "deal_finder" / "data" / "live_runs" / "hourly_all_models_benchmark" / "tracked_model_threshold_items.csv"
CASCADE_LIVE_CSV = ROOT / "experiments" / "old" / "benchmark_basic_to_full" / "data" / "live_runs" / "cascade_live" / "tracked_items.csv"
