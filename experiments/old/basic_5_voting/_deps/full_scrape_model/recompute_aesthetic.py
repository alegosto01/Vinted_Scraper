...
from experiments.old.basic_5_voting._deps.photo_arbitrage.quality_methods import (
...
def regenerate_dataset(visual_path: Path, dataset_dir: Path, search: str) -> None:
    ...
    from experiments.old.basic_5_voting._deps.full_scrape_model.compare_feature_modalities import (
