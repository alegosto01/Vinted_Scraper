...
from experiments.old.basic_5_voting._deps.deal_finder.dataset import build_datasets, parse_timestamp_series, safe_feature_columns
...
def train_offline(
    *,
    ...
    if qualified and auto_paper_trading:
        from experiments.old.basic_5_voting._deps.deal_finder.paper_trading import collect_snapshot
