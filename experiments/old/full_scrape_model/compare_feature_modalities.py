...
from experiments.old.full_scrape_model._deps.deal_finder import model_sweep as base_sweep
from experiments.old.full_scrape_model._deps.deal_finder.modeling import TARGET_COL, score_with_model
from experiments.old.full_scrape_model.dataset import (
    TASK_SOLD_STATUS,
    available_searches,
    build_search_dataset,
    normalize_id_value,
)
from experiments.old.full_scrape_model.paths import (
    EXPERIMENT_ROOT,
    MODELS_DIR,
    OFFLINE_RUNS_DIR,
    ROOT,
