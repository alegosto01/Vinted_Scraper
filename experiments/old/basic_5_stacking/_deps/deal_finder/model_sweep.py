...
from experiments.old.basic_5_stacking._deps.deal_finder.dataset import build_datasets, safe_feature_columns
from experiments.old.basic_5_stacking._deps.deal_finder.modeling import (
    TEXT_CANDIDATES,
    TARGET_COL,
    ELIGIBLE_COL,
    SplitFrames,
...
def run_sweep(
    *,
    ...
    # ── Experiment tracker ──────────────────────────────────────────────────
    try:
        from experiments.old.basic_5_stacking._deps.tracking.db import init_db, log_run, log_metrics
        init_db()
