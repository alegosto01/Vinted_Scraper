...
from experiments.old.basic_5_stacking._deps.deal_finder.dataset import add_identity
from experiments.old.basic_5_stacking._deps.deal_finder.model_sweep import (
    IMAGE_FEATURES,
    RulePriceScorer,
...
from experiments.old.basic_5_stacking._deps.deal_finder.modeling import load_pickle, score_with_model
from experiments.old.basic_5_stacking._deps.deal_finder.paper_trading import (
    checkpoint_due_mask,
    ensure_outcome_columns,
    load_search_config_by_folder,
    update_outcome_windows,
)
from experiments.old.basic_5_stacking._deps.deal_finder.paths import (
    LIVE_RUNS_DIR,
    MODELS_DIR,
