...
from experiments.old.basic_plus_visual.paths import (
...
from experiments.old.basic_plus_visual._deps.full_scrape_model.compare_feature_modalities import add_dino_embedding_columns
...
def run_collect_once(
    ...
    for search_name in search_names:
        ...
        try:
            from experiments.old.basic_plus_visual._deps.photo_arbitrage.features import add_photo_features
            from experiments.old.basic_plus_visual._deps.photo_arbitrage.quality_methods import add_quality_method_scores, MethodConfig
