...
from experiments.old.basic_plus_visual._deps.full_scrape_model.dataset import TASK_CHOICES, build_datasets
...
def run_sweep(
    *,
    ...
    # ── Experiment tracker ──────────────────────────────────────────────────
    try:
        from experiments.old.basic_plus_visual._deps.tracking.db import init_db, log_run, log_metrics
        init_db()
