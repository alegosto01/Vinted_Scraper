...
Retired: this approach was backed out (see
``wiki/experiments/experiment_tried/giant_5basic/lowered-thresholds-plus-reranker.md``,
status "backed out"). Kept for reproducibility only; not part of the live pipeline.
"""
...
from experiments.old.full_scrape_reranker.paths import (  # noqa: E402
    EXPERIMENT_ROOT,
    MODELS_DIR,
